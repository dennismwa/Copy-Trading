            ...
            <div class="glass-card rounded-xl p-8">
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-gray-800/50 rounded-lg p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-gray-400 text-sm">Latest ROI Earned</p>
                                <p class="text-2xl font-bold text-yellow-400"><?php echo formatMoney($latest_roi_earned); ?></p>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-800/30 rounded-lg hover:bg-gray-800/50 transition">
                            ...
                            <div class="text-right">
                                ...
                                if ($transaction['type'] === 'roi_payment') {
                                    ...
                                    echo '<p class="font-bold text-white">' . formatMoney($roi_amount) . '</p>';
                                } else {
                                    echo '<p class="font-bold text-white">' . formatMoney($transaction['amount']) . '</p>';
                                }
                                ?>
                                <p class="text-sm <?php 
